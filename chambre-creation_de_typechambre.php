<div class="corp" style="min-height:400px;">
    ...
    <div class=" col-xs-12 col-sm-6 col-md-6 col-lg-6">
        ...
        <form method="get" action="traitement.php" id="formSaveDirection">
            <h5 class="text-center" style="padding:20px;"><b>Enregistrer un nouveau Type de chambre</b></h5>
                ...
                <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5"><label class="label" for="direction">Nom du type</label></div>
                ...
                <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5"><label class="label" for="atsortieClient">Description du type</label></div>
